...
public class FractionEqualsTest {
    ...
    public static class SymmetricProperty {
        @DataPoints
        public static final Fraction[] notAllDifferentValues = new Fraction[]{
                new Fraction(1, 2),
                new Fraction(3, 4),
                new Fraction(-7, 8),
                new Fraction(9, -10),
                new Fraction(5),
                new Fraction(0),
                new Fraction(4 * 1, 4 * 2),
                new Fraction(4 * 3, 4 * 4),
                new Fraction(4 * (-7), 4 * 8),
                new Fraction(4 * 9, 4 * (-10)),
                new Fraction(4 * 5),
                new Fraction(4 * 0),
                new Fraction(-7 * 1, -7 * 2),
                new Fraction(-7 * 3, -7 * 4),
                new Fraction(-7 * (-7), -7 * 8),
                new Fraction(-7 * 9, -7 * (-10)),
                new Fraction(-7 * 5),
                new Fraction(-7 * 0),
        };
